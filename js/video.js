...
video4.pause();
const video5 = document.getElementById('video-bear');
video5.pause();
...
AFRAME.registerComponent('listener', {
  tick: function () {
    ...
    if ((userPosition["z"] <= -12.3) && (userPosition["z"] > -25) && (userPosition["x"] > -25.55) && (userPosition["x"] < -11)) {
      video2.play();
    } else {
      video2.pause();
    }

    if ((userPosition["z"] <= -12.3) && (userPosition["z"] > -25) && (userPosition["x"] > -9) && (userPosition["x"] < 9.65)) {
      video3.play();
    } else {
      video3.pause();
    }

    if ((userPosition["z"] <= -12.3) && (userPosition["z"] > -25) && (userPosition["x"] > 11.6) && (userPosition["x"] < 26)) {
      video4.play();
    } else {
      video4.pause();
    }
